...
public class GuiApp extends JFrame {
  ...
  String RemoveFlightText = "Remove Flight";
  String CancelFlightText = "Cancel Flight";
  String NotifyBoardingText = "Notify Boarding";
  String ChangeGateText = "Change Gate";
  String SauvegarderLesVolsText = "Sauvegarder les vols ";
  String ChargerLesVolsText = "Charger les vols";
  ...
  private JButton addButton, delayButton, quitButton, removeButton, cancelButton,
          notifyButton, changeButton, chargerButton, sauvegarderButton;
  // TODO: Add attributes for other operations
  ...
  public void initComponents() {
    ...
    changeButton = new JButton(ChangeGateText);

    sauvegarderButton = new JButton(SauvegarderLesVolsText);

    chargerButton = new JButton(ChargerLesVolsText);
  ...
  public void initContentPane() {
    ...
    contentPane.add(sauvegarderButton);
    contentPane.add(chargerButton);
  ...
  public void initListeners() {
    ...
    notifyButton.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent e) {
        displayArea.append("Notify Flight Option");
        System.out.println("Notify Flight Option");
        NotifyFlightDialog notifyFlightDialog = new NotifyFlightDialog(GuiApp.this);
        notifyFlightDialog.setVisible(true);
      }
    });
    ...
    sauvegarderButton.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent e) {
        displayArea.append("Sauvegarder les vols Option");
        System.out.println("Sauvegarder les vols Option");
        SauvegarderLesVolsDialog sauvegarderLesVolsDialog = new SauvegarderLesVolsDialog(GuiApp.this);
        sauvegarderLesVolsDialog.setVisible(true);
      }
    });
    chargerButton.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent e) {
        displayArea.append("Charger les vols Option");
        System.out.println("Charger les vols Option");
        ChargerLesVolsDialog chargerLesVolsDialog = new ChargerLesVolsDialog(GuiApp.this);
        chargerLesVolsDialog.setVisible(true);
      }
    });
  ...
  public void RemoveFlight(String company, int flightNumber, String terminal, int gateNumber) {
    ...
    if (flightToRemove != null) {
      ...
      terminal = flightToRemove.getGate().substring(0, 1);
      gateNumber = Integer.parseInt(flightToRemove.getGate().substring(2));
  ...
  public void SauvegarderLesVols(String company, int flightNumber, String destination, int departureTime, String terminal, int gateNumber) {
  }

  public void ChargerLesVols(String company, int flightNumber, String destination, int departureTime, String terminal, int gateNumber) {
  }


  public void CancelFlight(String company, int flightNumber, String terminal, int gateNumber) {
    List<Flight> flights = airport.getFlights();
  ...
  public void ChangeGate(String company, int flightNumber, String newTerminal, int newGate) {
  ...
  public void delayFlight(String company, int flightNumber, String terminal, int gateNumber) {
  ...
  public void notifyBoarding(String company, int flightNumber, String terminal, int gateNumber) {
